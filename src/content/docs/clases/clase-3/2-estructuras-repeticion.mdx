...
1. Se ejecuta la instrucción de inicialización o contador interno `let i = 20;`, que se encarga de inicializar el valor de la variable de control (`i`) del bloque `for`. En este caso se inicia en `20`.
