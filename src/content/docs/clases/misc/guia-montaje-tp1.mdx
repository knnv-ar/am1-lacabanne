...
- `dependencies`: Un listado (con guiones) de las librerías que utiliza tu sketch. Podes usar versiones específicas como la versión actual 2 `v2.3.3` o la versión anterior 1 `p5.v1.11.13`.
